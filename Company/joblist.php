                                ...
                                <div class="col-md-8 d-flex align-items-center">
                                 ...
                                 <div class="col-sm-12 col-md-4 d-flex flex-column align-items-start align-items-md-end justify-content-center">
                                        <div class="d-flex mb-3">
                                            <a class="btn btn-primary" href="jobdetails.php?postid=<?php echo $r['postid'];?>">View Details</a>
                                        </div>
                                    <small>
                    ...
                    <?php while ($r2 = mysqli_fetch_array($res2)) { ?>
                        <div class="job-item p-4 mb-4 border rounded">
                            <div class="row g-4">
                                ...
                                <div class="col-sm-12 col-md-4 d-flex flex-column align-items-start align-items-md-end justify-content-center">
                                        <div class="d-flex mb-3">
                             <a class="btn btn-primary" href="jobdetails.php?postid=<?php echo $r2['postid'];?>">View Details</a>
                                        </div>
                                    <small>
                                        <i class="far fa-calendar-alt text-primary me-2"></i>
