        ...
        <div class="row gy-5 gx-4">
            ...
            <div class="col-lg-8">
                   ...
                   if ($jobtime == "fulltime") 
                {
                    ...
                    ?><img class="img-fluid border rounded-circle" src="img/parttime.png" alt="Part-time" style="width: 80px; height: 80px;"><?php
                    }
                        ?>
                    <div class="text-start ps-4">
                        <h3 class="mb-3"><?php echo $postname; ?></h3>
...
<div class="col-lg-12 mt-4">
    <div class="d-flex justify-content-center justify-content-md-start gap-3 flex-wrap">
        <a href="jobedit.php?id=<?php echo $postid; ?>" 
           class="btn btn-outline-primary btn-lg px-4 py-2">
            <i class="fa fa-edit me-2"></i> Edit
        </a>
        <a href="jobdelete.php?id=<?php echo $postid; ?>" 
           class="btn btn-outline-danger btn-lg px-4 py-2"
