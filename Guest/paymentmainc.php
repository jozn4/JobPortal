            ...
            <div class="card shadow-lg border-0">
                <div class="card-body p-4">
                    ...
                    if (isset($_POST['pay'])) {
                        ...
                        $update = "UPDATE tbl_paymentplanc SET status='Paid',renewaldate='$ren' WHERE payid='$payid'";
                        $result = $obj->executequery($update);
                        $update1 = "UPDATE tbl_company SET renewaldate='$ren',plan_id='$pid' WHERE companyid='$comid'";
