        ...
        <div class="row gy-5 gx-4">
            ...
            <div class="col-lg-8">
                <div class="d-flex align-items-center mb-5">
                    <img class="img-fluid border rounded-circle" src="../uploads/<?php echo($row['photo']); ?>" alt="Full-time" style="width: 80px; height: 80px;">
...
<div class="col-lg-12 mt-4">
    <div class="d-flex justify-content-center justify-content-md-start gap-3 flex-wrap">
        <a href="userregister.php" class="btn btn-outline-primary btn-lg px-4 py-2">
