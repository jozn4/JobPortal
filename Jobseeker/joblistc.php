...
$s1 = "SELECT * FROM tbl_companypost c 
        ...
        WHERE jobtime = 'fulltime' and j.jobtypeid=$cid";
...
$s2 = "SELECT * FROM tbl_companypost c 
        ...
        INNER JOIN tbl_location l ON l.locationid = cy.locationid 
        INNER JOIN tbl_district d ON d.districtid = l.districtid 
        WHERE jobtime = 'parttime' and j.jobtypeid=$cid";
 ...
 <!-- Header End -->
        <div class="container-xxl py-5 bg-dark page-header mb-5">
            <div class="container my-5 pt-5 pb-4">
                <h1 class="display-3 text-white mb-3 animated slideInDown">Job List By Category</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb text-uppercase">
                        <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                        <li class="breadcrumb-item"><a href="#">Pages</a></li>
                        <li class="breadcrumb-item text-white active" aria-current="page">Job List Category </li>
                    </ol>
                </nav>
            </div>
        </div>
...
<img class="img-fluid border" src="../uploads/<?php echo($r['photo']); ?>" alt="Company Logo" style="width: 80px; height: 80px; object-fit: contain; border-radius: 10px;">
                                    <div class="text-start ps-4">
                                        <h5 class="mb-3"><?php echo $r['postname']; ?></h5>
...
<img class="img-fluid border" src="../uploads/<?php echo($r2['photo']); ?>" alt="Company Logo" style="width: 80px; height: 80px; object-fit: contain; border-radius: 10px;">
                                    <div class="text-start ps-4">
                                        <h5 class="mb-3"><?php echo $r2['postname']; ?></h5>
