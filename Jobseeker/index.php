...
<div class="container-fluid p-0">
    <div class="owl-carousel header-carousel position-relative">
        ...
        <div class="owl-carousel-item position-relative">
            <img class="img-fluid" src="img/carousel-1.jpg" alt="Job Search">
                    ...
                    <div class="row justify-content-start">
                        <div class="col-10 col-lg-8">
                            ...
                            <p class="fs-5 fw-medium text-white mb-4 pb-2">
                                Explore thousands of opportunities from top companies. Start your career journey and take the next big step toward success.
                            </p>
                            <a href="allcompany.php" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Browse Jobs</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- Slide 2 -->
        <div class="owl-carousel-item position-relative">
            <img class="img-fluid" src="img/carousel-2.jpg" alt="Startup Jobs">
            <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center" style="background: rgba(43, 57, 64, .5);">
                <div class="container">
                    <div class="row justify-content-start">
                        <div class="col-10 col-lg-8">
                            <h1 class="display-3 text-white animated slideInDown mb-4">Discover Opportunities That Match You</h1>
                            <p class="fs-5 fw-medium text-white mb-4 pb-2">
                                Whether you’re looking for your first job or the next challenge, we connect you with employers who value your skills and passion.
                            </p>
                            <a href="allcompany.php" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Get Started</a>
                        </div>
                    </div>
                </div>
            </div>
...
<?php while ($r4 = mysqli_fetch_array($jres)) { ?>
      ...
      <a class="btn btn-primary py-3 px-5" href="allcategory.php">Browse More Category</a>
    </div>
    </div>
</div>
<!-- Category End -->
...
<img class="img-fluid border" src="../uploads/<?php echo($r['photo']); ?>" alt="Company Logo" style="width: 80px; height: 80px; object-fit: contain; border-radius: 10px;">
                ...
                <div id="tab-2" class="tab-pane fade p-0">
                    <?php while ($r2 = mysqli_fetch_array($res2)) { ?>
                        <div class="job-item p-4 mb-4 border rounded">
                            <div class="row g-4">
                                <div class="col-md-8 d-flex align-items-center">
<img class="img-fluid border" src="../uploads/<?php echo($r2['photo']); ?>" alt="Company Logo" style="width: 80px; height: 80px; object-fit: contain; border-radius: 10px;">
                                    <div class="text-start ps-4">
